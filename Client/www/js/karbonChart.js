window.onload = function () {
	...
	$.getJSON("http://13.67.76.30/sensor/100", function(data){
	...
	let popChart = new Chart(myChart,{
		...
		data:{
			...
			datasets:[{
				...
				data: datapoints,
				backgroundColor:'rgba(100, 192, 99, 0.6)'
	...
	$.getJSON("http://13.67.76.30/statistik", function(data){
	  ...
	  var myHTML = "";
		var myHTML = "<tr><td>Nilai</td><td>"+data[0].max.karbon+"</td><td>"+data[0].min.karbon+"</td><td>"+data[0].average.karbon+"</td></tr>"
